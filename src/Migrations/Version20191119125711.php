 ...
 */
final class Version20191119125711 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT AUTO_INCREMENT NOT NULL, choise_id INT NOT NULL, user_id INT NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_DADD4A25F966F153 (choise_id), INDEX IDX_DADD4A25A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE answer ADD CONSTRAINT FK_DADD4A25F966F153 FOREIGN KEY (choise_id) REFERENCES choice (id)');
